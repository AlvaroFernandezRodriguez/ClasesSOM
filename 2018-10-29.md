...
ls*.log -recourse -force
- Listar los ficheros sin las extensiones .dll
ls -Exclude *.dll
- Crear un directorio para cada usuario
New-item -ItempType Directory AlvaroTyson
- Crear un fichero para cada usuario
New-item -Path AlvaroTyson -Name fichero.txt
- Añadir contenido a cada fichero creado para cada usuario
New-item -Path .\Alvarotyson -Name fichero.txt -Itemptype file -Value "soy un hacker"
- Eliminar un directorio
rm .\AlvaroTyson
- Renombrar un directorio
Rename-Item .\Alvarotyson
---------------------
